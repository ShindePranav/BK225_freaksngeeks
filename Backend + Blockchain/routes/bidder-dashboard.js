...
const {acceptBidContract}=require('../build/contracts/ABI')
...
//console.log(req.body)
	...
	const tender=await issueTenderContract.methods.viewTender(req.body.referenceNo).call().then(function(res){
		return res;
	})
  if(bidder){
